...
class MW(QWidget):
    ...
    def print_qsize(self):
        ...
        print('==============================')
        print("label0's size      :", self.label0.size(), "/", self.label0.sizePolicy().verticalPolicy(), "/",
              self.label0.sizePolicy().horizontalPolicy())
        print("label1's size      :", self.label1.size(), "/", self.label1.sizePolicy().verticalPolicy(), "/",
              self.label1.sizePolicy().horizontalPolicy())
        print("label2's size      :", self.label2.size(), "/", self.label2.sizePolicy().verticalPolicy(), "/",
              self.label2.sizePolicy().horizontalPolicy())
        print("line_edit's size   :", self.line_edit.size(), "/", self.line_edit.sizePolicy().verticalPolicy(), "/",
              self.line_edit.sizePolicy().horizontalPolicy())
        print("push_button's size :", self.push_button.size(), "/", self.push_button.sizePolicy().verticalPolicy(), "/",
              self.push_button.sizePolicy().horizontalPolicy())
